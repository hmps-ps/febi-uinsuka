...
// Set environment variables with VITE_ prefix (e.g. VITE_SUPABASE_URL)
// - Locally: create a .env.local (do NOT commit)
// - Vercel: add VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in Project Settings
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL as string | undefined;
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY as string | undefined;

if (!supabaseUrl || !supabaseAnonKey) {
  throw new Error(
    'Missing VITE_SUPABASE_URL or VITE_SUPABASE_ANON_KEY. Set env variables.'
  );
}
